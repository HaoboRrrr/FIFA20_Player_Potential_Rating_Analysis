...
The column selected is overall, shooting, passing, physic, wage and international_reputation. We eliminated all goal keepers and randomly selected 30% of original observation, and replaced 0 salary with 1 to analyse.
...
* wage_eur measures the player's weekly salary in Euro.
* international_reputation measures the player's popularity in the world.
