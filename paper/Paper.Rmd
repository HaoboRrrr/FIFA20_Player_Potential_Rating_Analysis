...
By looking at the Box-cox transformation, we noticed that we need to apply transformations to the predictors to improve our model: wage_eur^0.25, passing^2, physic^2 for simplicity purpose.
