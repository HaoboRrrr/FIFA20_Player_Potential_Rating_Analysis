...
```{r}
write.csv(players_20, "data/cleaned_data/cleaned_data.csv")
```
...
fit_rating_better = lm(overall ~ poly(age, 2) + wage_eur + international_reputation +passing + physic, data = players_20)
