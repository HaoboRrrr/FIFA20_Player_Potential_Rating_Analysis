...
###overall try fit
```{R}
fit_rating = lm(overall ~ value_eur + wage_eur + international_reputation +pace
...
plot(fitted_value,players_20$overall, xlim=c(50,90))
abline(0, 1, col='blue')
```
...
###player value fit
```{R}
fit_value = lm(value_eur ~ overall + wage_eur + international_reputation +pace
  + shooting +passing + dribbling + defending + physic, data = players_20)
