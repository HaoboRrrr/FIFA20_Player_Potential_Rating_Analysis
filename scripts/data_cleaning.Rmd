...
players_20$Top_Club  <- ifelse(players_20$club %in% c("Real Madrid","FC Barcelona","Bayern Munich","Atlético Madrid","Juventus","Manchester City","Paris Saint-Germain","Liverpool","Sevilla FC","Arsenal"),"Top_10",
...
```{R}
final_data <- players_20 |> select(overall, shooting, wage_eur, international_reputation, passing, physic)

fit_rating_better = lm(overall ~ shooting + wage_eur + international_reputation +passing + physic, data = final_data)
